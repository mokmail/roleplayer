...
import { SceneContext, Character, Message, AIConfig } from '../types';
import { Users, Sparkles, UserPlus, Trash2, Edit3, Circle, CheckCircle2, Eye, UserCircle2, UserCheck, Users2 } from 'lucide-react';
...
export const CharactersPage: React.FC<CharactersPageProps> = ({
  ...
  const [showCastView, setShowCastView] = useState(true);
  ...
  return (
    <div className="h-full flex flex-col bg-transparent">
      ...
      />
      <div className="px-6 py-5 border-b border-white/5 flex items-center justify-between bg-black/10 backdrop-blur-sm sticky top-0 z-10 gap-3">
